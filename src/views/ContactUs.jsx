...
const ContactUs = () => {
  ...
  return (
    <div className="flex flex-col  items-center scroll-smooth w-full  min-h-screen overflow-y-auto text-black bg-white">
      <div className="contact-container mx-auto pb-60 grid grid-cols-1 gap-4 bg-white rounded overflow-hidden md:w-80 lg:max-w-2xl md:m-auto md:w-90 md:max-w-full lg:grid-cols-2 lg:gap-6 lg:w-full lg:mt-20">
        <div className="form-container p-5 ">
          ...
          <form className="contact-form grid gap-y-4" onSubmit={handleSubmit}>
            ...
            ></textarea>
            <input
              className="send button w-full bg-red-100 p-4 rounded-lg text-sm font-medium cursor-pointer transition duration-300 ease-linear hover:bg-red-400"
              type="submit"
              value="Send"
            />
          </form>
